    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-stone-900 border border-stone-800 rounded-2xl p-8 shadow-2xl">
          <h1 className="font-serif text-3xl text-stone-100 mb-1">Create account</h1>
          <p className="text-stone-500 text-sm mb-8">Start your productivity journey today</p>
          ...
          <div className="flex items-center gap-4 mb-6">
            <label htmlFor="profile-upload" className="cursor-pointer group">
              <div className="w-16 h-16 rounded-full overflow-hidden bg-stone-800 border-2 border-stone-700 group-hover:border-amber-400 transition-colors flex items-center justify-center">
                {profilePreview ? (
            ...
            <div>
              ...
              <p className="text-xs text-stone-500">Click to upload (optional)</p>
            </div>
          </div>
